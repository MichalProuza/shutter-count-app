...
- Canon `CR3`: confirmed support for known model-specific offsets on `R5`, `R6`, `R6 Mark II`, `R8`, `R50`, `R5 C`, `R6 Mark III`, `R50 V`, `R1`
...
Support claims were checked against full GitHub release batches `Zoner_D` through `Zoner_D4`.
